...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8" style={{backgroundColor:"#E8FFCC"}}>
      <div className="max-w-md w-full space-y-8" style={{backgroundColor:"#C1FF72", minHeight:"290px", minWidth:"500px", paddingLeft:"10px", paddingRight:"10px", borderRadius:"20px"}} >
